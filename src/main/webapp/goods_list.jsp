                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">goodId:${goods.goodId}</td>
                                            <td class="left"><a href="http://localhost:8080/1801_1/cust/goods/list#" onclick="window.location.href='/cust/goods/add?good_id=${goods.goodId}'" onmouseover="alert(${goods.goodId})">${goods.goodName}</a></td>
